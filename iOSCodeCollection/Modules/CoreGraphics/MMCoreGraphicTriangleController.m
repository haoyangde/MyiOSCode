//
//  MMCoreGraphicTriangleController.m
//  iOSCodeCollection
//
...
- (void)drawRect:(CGRect)rect
{
    ...
    [@"画三角形：" drawInRect:CGRectMake(10, 260, 100, 20) withAttributes:@{NSFontAttributeName:font,NSForegroundColorAttributeName:[UIColor redColor]}];
    ...
    [@"画贝塞尔曲线：" drawInRect:CGRectMake(10, 340, 80, 20) withAttributes:@{NSFontAttributeName:font,NSForegroundColorAttributeName:[UIColor redColor]}];
...
@interface MMCoreGraphicTriangleController ()

@end

@implementation MMCoreGraphicTriangleController
...
- (void)viewDidLoad {
    ...
    TriangleView *view = [[TriangleView alloc] initWithFrame:CGRectMake(0, 50, self.view.frame.size.width, self.view.frame.size.height)];
